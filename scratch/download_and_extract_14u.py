...
url = "https://drive.google.com/drive/folders/1auQkpVZP38R0v_qVqQ7LDVODBej_Sn_m?usp=sharing"
headers = {
...
try:
    ...
    with open("scratch/egoist_14u_folder.html", "w", encoding="utf-8") as f:
        f.write(html)
    ...
    for match in matches:
        ...
        # Exclude folder ID itself: 1auQkpVZP38R0v_qVqQ7LDVODBej_Sn_m
